...
<body>
	...
	<div class="container">
		<div class="row">
				...
				<table class="table table-light">
					...
					<tbody>
						<c:forEach var="gender" items="${allGenders}">
							<tr>
								<td><c:out value="${gender.id}"></c:out></td>
								<td><c:out value="${gender.name}"></c:out></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
			...
			<div class="col">
				<h1>Create Gender</h1>
				<form:form action="/super-admin/gender" method="post"
					modelAttribute="newGender" class="p-3 bg-light">
					<table class="w-100">
						<tbody>
							<tr>
								<td><form:label path="name">Gender Name:</form:label></td>
