...
<title>Create Hero Specialties</title>
<!-- for Bootstrap css -->
...
<body>
	...
	<div class="container">
		<div class="row">
				...
				<table class="table table-light">
					...
					<tbody>
						<c:forEach var="specialty" items="${allSpecialties}">
							<tr>
								<td><c:out value="${specialty.id}"></c:out></td>
								<td><c:out value="${specialty.name}"></c:out></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
			...
			<div class="col">
				<h1>Create Hero Specialty</h1>
				<form:form action="/super-admin/hero-specialty" method="post"
					modelAttribute="newHeroSpecialty" class="p-3 bg-light">
					<table class="w-100">
						<tbody>
							<tr>
								<td><form:label path="name">Specialty Name:</form:label></td>
